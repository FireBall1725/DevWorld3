package ca.fireball1725.devworld.forge.config;
...
public class DevWorldConfigImpl implements DevWorldConfig {
    ...
    private static class Config {
        final ForgeConfigSpec.BooleanValue enableBonusChest;
        final ForgeConfigSpec.ConfigValue<String> flatworldGeneratorString;
        final ForgeConfigSpec.BooleanValue ruleDaylight;
        final ForgeConfigSpec.IntValue daylightValue;
        final ForgeConfigSpec.BooleanValue ruleWeatherCycle;
        final ForgeConfigSpec.BooleanValue ruleDoFireTick;
        final ForgeConfigSpec.BooleanValue ruleMobGriefing;
        final ForgeConfigSpec.BooleanValue ruleDoMobSpawning;
        final ForgeConfigSpec.BooleanValue ruleDisableRaids;
        final ForgeConfigSpec.BooleanValue ruleDoInsomnia;
